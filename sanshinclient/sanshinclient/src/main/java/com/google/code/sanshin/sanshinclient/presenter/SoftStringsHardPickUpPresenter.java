...
public class SoftStringsHardPickUpPresenter implements SanshinModelListener,
        FingerPositionListener, PickUpListener {
    private static final String TAG = SoftStringsHardPickUpPresenter.class.getSimpleName();

    private SanshinView mView;
    private SanshinModelImpl mModel;

    public SoftStringsHardPickUpPresenter(SanshinView view) {
        mView = view;
    }
